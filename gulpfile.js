...
gulp.task('templates', function() {
    var templateData = JSON.parse(fs.readFileSync('src/data/data.json', 'utf-8'));
    var options = {
...
gulp.task('watch', function() {
    gulp.watch(['./src/templates/**/*.hbs', './src/partials/**/*.hbs', './src/data/data.json'], ['templates'], reload);
...
gulp.task('build:optimized', function(cb) {
    return runSequence('clean', ['sass:optimized', 'images:optimized', 'fonts', 'js', 'templates:optimized'],
        cb);
});
